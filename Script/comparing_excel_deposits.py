...
old_file = US+"US_FINAL_Deposits_Data_2018_09_21.csv" #Please enter the path of Old file
new_file = US+"US_FINAL_Deposits_Data_2018_09_25.csv"#Please enter the path of New file
outputFile = US+"Deposit_comparision_US.csv" #Please enter the path of output file
