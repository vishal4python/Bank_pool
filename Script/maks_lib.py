...
scripts = path.join(path.dirname(path.dirname(path.realpath(__file__))), "scripts\\")
US = path.join(path.dirname(path.dirname(path.realpath(__file__))), "data\output\\US\\")
