...
class App:
    ...
    def __init__(self, url='https://www.pnc.com/en/personal-banking/borrowing/home-lending/mortgages/FHA-Loan.html',
    ...
    def data_page(self):
        ...
        for pro in pro_name:
            if pro.getText() is not None:
                # print(pro.getText())
                Term.append(pro.getText().rstrip("Yr Fixed \xa0 ").lstrip("FHA"))
...
if __name__ == '__main__':
    ...
    df = df.iloc[0:2,:]
    df.to_csv(output_path + "PNC_Data_Mortgage_1lakh_FHAR.csv".format(now.strftime("%m_%d_%Y")), index=False)